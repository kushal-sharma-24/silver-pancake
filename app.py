...
BLOCKED_PATHS = {".github", ".git", "Dockerfile", ".env", ".dockerignore"}
...
def get_repo_summary(workspace: pathlib.Path, max_chars: int = 6000) -> str:
...
async def github_webhook(
    ...
    background_tasks.add_task(
        process_pr_revision,
        pr_api_url, comments_url, comment_body, job_id,
    )
    return JSONResponse(
        status_code=202,
